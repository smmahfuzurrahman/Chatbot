...
import chatbotlogo2 from '@/assets/chatbotlogo2.png'
                    ...
                    allMessages.length > 0 ?
                        <div className={styles.messages}>
                            {allMessages.map((msg, index) => (
                                <div key={index} className={styles.message}>
                                    <Image src={msg.role === 'user' ? userlogo : chatbotlogo2} width={50} height={50} alt="" />
                        ...
                        <div className={styles.nochat}>
                            <div className={styles.s1}>
                                <Image src={chatbotlogo} alt="chatgpt" height={70} width={70} />
